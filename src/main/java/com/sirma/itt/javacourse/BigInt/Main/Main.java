package main.java.com.sirma.itt.javacourse.BigInt.Main;
...
class Main {
	...
	public static void main(String[] args) {
		...
		for (int firstNumberIndex = size - 1, secondNumberIndex = size - 1, sumIndex = size; sumIndex >-1; firstNumberIndex--, secondNumberIndex--, sumIndex--) {
			...
			// no digits left in the second but we add some from the first number
		...
		if (sum[0]-'0' !=0 ) {//nothing special, only checking if we need to add new digit to the sum
